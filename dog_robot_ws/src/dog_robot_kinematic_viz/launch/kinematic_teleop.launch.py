"""Full 4-leg kinematic rig + keyboard teleop in a new terminal.

Same as kinematic.launch.py plus a teleop_keyboard node launched via
gnome-terminal so it has a real TTY for raw-mode key reads.
"""
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        rsp, static_tf, kinematic_node, teleop, rviz,
    ])
